...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants: Record<string, string> = {
      ...
      secondary:
        "bg-slate-100 text-slate-900 hover:bg-slate-200 active:bg-slate-200 dark:bg-slate-800 dark:text-slate-100 dark:hover:bg-slate-700",
      ghost: "text-slate-600 hover:bg-slate-100 active:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800",
